...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('my__parents', function (Blueprint $table) {
            ...
            $table->foreignId('Blood_Type_Father_id')->constrained('type__bloods')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->foreignId('Blood_Type_Mother_id')->constrained('type__bloods')->onDelete('cascade')->onUpdate('cascade');
